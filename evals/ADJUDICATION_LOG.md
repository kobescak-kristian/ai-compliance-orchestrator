...
| D2 | p04 · GBR-RG-02 | **NOT_APPLICABLE stands, overriding the blind label** | GBR-RG-02 governs pages promoting a gambling offer; P04 promotes operators via play links but presents no offer. The blind labeler read "promoting" broadly; the rule text's object is the offer, not the operator. Adjudicated to the draft key. |
